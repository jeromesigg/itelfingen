...
@section('content')
  ...
  <div id="app">
    <section class="bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-16">
      <div class="mx-auto max-w-(--breakpoint-2xl) px-4 2xl:px-0">
        <div class="mx-auto max-w-5xl md:max-w-5xl">
          ...
          <div class="mt-6 grid grid-cols-1 gap-6 sm:mt-8 sm:gap-8 md:grid-cols-2 lg:gap-2.5 xl:mt-12">
            ...
            <div class="space-y-4">
              <div class="space-y-4 rounded-lg border border-gray-200 bg-white p-6 shadow-xs dark:border-gray-700 dark:bg-gray-800">

            ...
            <div class="card" style="width: 100%">
              <div class="card_content">
                ...
                <p class="card_text">
                  ...
                  <span class="card_subtitle">Genossenschafter:innne</span>
          ...
          <div class="col-lg-6">
            <div class="card card_title-line_white">
              <div class="card_content">
                ...
                <p class="card_text">
                  Falls Du das Haus nur für einen Tag mieten willst, nimm bitte mit der Verwaltung <a href="#contact">Kontakt</a> auf.
                </p>
              </div>    
           </div>        
            <div class="card">

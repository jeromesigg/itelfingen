...
@section('content')
    <div class="block p-6 mb-5 bg-white border border-gray-200 rounded-lg shadow-xs dark:bg-gray-800 dark:border-gray-700">
        <h2 class="text-4xl font-bold dark:text-white mb-5">Änderungen und Anpassungen</h2>
        <ol class="relative border-s border-gray-200 dark:border-gray-700">         
            <li class="mb-10 ms-6">     
                <span class="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -inset-s-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">

  ...
  <section class="mt-30px mb-30px">
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-4 col-md-12">
          ...
          <div id="new-events" class="card updates recent-updated">
            <div id="updates-header" class="card-header d-flex justify-content-between align-items-center">
              <h2 class="h5 display"><a data-toggle="collapse" data-parent="#new-events" href="#events-box" aria-expanded="true" aria-controls="events-box">Die neusten Buchungen</a></h2>
        ...
        <div class="col-lg-4 col-md-12">
          <!-- Recent Updates Widget          -->
          <div id="current-events" class="card updates recent-updated">
            <div id="updates-header" class="card-header d-flex justify-content-between align-items-center">
              <h2 class="h5 display"><a data-toggle="collapse" data-parent="#current-events" href="#events-box" aria-expanded="true" aria-controls="events-box">Die aktuellen Buchungen</a></h2>
              <a data-toggle="collapse" data-parent="#current-events" href="#current-events-box" aria-expanded="true" aria-controls="events-box"><i class="fa fa-angle-down"></i></a>
            </div>
            <div id="current-events-box" role="tabpanel" class="collapse show">
              <ul class="news list-unstyled">
                <!-- Item-->
